...
<body>
	<br> <br>
	<h2 style="color:white;text-align:center" >LEVEL 10 </h2>
	<h2 style="color:white;text-align:center"> Crack the Pre Shared Key of a WiFi Network <br> <br></h2>
	
	
<div  class="modal" >
<br> <br>
	<br> <br>
	<form method="post" class="modal-content animate" action="level11.php">
	 ...
	 <div class="container">
      ...
      <input type="submit" class="btn1" name="login" value="Submit!" id="wifi" >  
