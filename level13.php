...
<body>
	<br> <br>
	<h2 style="color:white;text-align:center" >LEVEL 13 </h2>
	<h2 style="color:white;text-align:center"> MANULA3 <br> <br></h2>
	
	
<div  class="modal" >
<br> <br>
	<br> <br>
	<form method="post" class="modal-content animate" action="level14.php">
	 ...
	 <div class="container">
      ...
      <input type="submit" class="btn1" name="login" value="Submit!" id="M3" >  
